...
val RustImplItemElement.traitName: String? get() = traitRef?.path?.referenceName

val RustImplItemElement.baseTypeName: String? get() = (type as? RustPathTypeElement)?.path?.referenceName
